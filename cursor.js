...
var classes = {}
var getClass=function(model) {
    if (!classes[model.constructor.name]){
        var Class = class {
...
export class FileCursor {
  constructor(_fileRef, _collection) {
      if(_collection&&_collection.collection&&_collection.collection._options&&_collection.collection._options.modelClass){
          var clazz = getClass(_fileRef);
          var result = new clazz(_fileRef);
